...
--
-- Host: localhost
-- Generation Time: Apr 27, 2012 at 08:12 AM
...
(3, 'http://www.google.com', 'Google', 'The hit on Tucker Hannon ', '2012-04-26 22:59:13', NULL),
(3, 'http://www.youtube.com', 'Youtube', 'Visualtraveling - Kim Il', '2012-04-26 22:59:13', NULL);
...
(3, 'Printer ser', 'Printer is part of the outputasdsad peripherals, which is used for implementation of computer information paper (a document, a picture or any other graphic file, an e-mail, article, etc..).', 'Printers ranked according to several criteria, eg. by purpose (printing / printing) and fast, the process, the maximum size of paper that prints and more.\r\n[edit] Types of printers\r\n\r\n     matrix (or "needle", low quality) - used for low quality sheets, invoices, etc.. (generally document type), only the printer model that allows simultaneous printing of two or three copies, using carbonless paper.\r\n     Inkjet - towards higher average quality - average speed - for documents and photos or graphic files)\r\n     laser (high speed / high quality) - uses a special toner\r\n     with thermal printing on special paper - for cards, cards etc..\r\n\r\nPrinters can print on paper sizes from A0 - only plotters (printers larger firms generally used for CAD, posters, etc.) to the envelopes, photos.', '2012-04-27 03:04:36', '2012-04-26 22:59:13');
...
(3, 'pTWRjZ_nP1M', 'youtube', 'The hit on Tucker Hannon ', '2012-04-26 22:59:13', NULL),
(3, '41074044', 'vimeo', 'Visualtraveling - Kim Il', '2012-04-26 22:59:13', NULL);
